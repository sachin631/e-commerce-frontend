...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 14572)), "C:\\Users\\Asus\\Desktop\\ecommerce\\frontend\\src\\app\\login\\page.js"],
    ...
    const pages = ["C:\\Users\\Asus\\Desktop\\ecommerce\\frontend\\src\\app\\login\\page.js"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 82313))
...
function Example() {
    ...
    const { register, handleSubmit, watch, formState: { errors }, reset } = (0,react_hook_form__WEBPACK_IMPORTED_MODULE_4__/* .useForm */ .cI)();
    const onSubmit = (data)=>{
        console.log(data);
    ...
    const { mutate, isLoading } = (0,_tanstack_react_query__WEBPACK_IMPORTED_MODULE_6__/* .useMutation */ .D)(async (data)=>{
        const res = await (0,_services_apis__WEBPACK_IMPORTED_MODULE_7__/* .userLogin */ .n$)(data);
        console.log("res", res);
        if (res.status !== 200) {
            throw new Error;
        }
        ...
        onSuccess: async ()=>{
            cogo_toast__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .ZP.success("login successFuly");
            reset();
        ...
        onError: ()=>{
            cogo_toast__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .ZP.error("Invalid Details");
        // setIsLoading(false);
        }
    });
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            isLoading ? cogo_toast__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .ZP.loading("loading...") : "",
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\Users\Asus\Desktop\ecommerce\frontend\src\app\login\page.js`)
...
var __webpack_exports__ = __webpack_require__.X(0, [904,97,698], () => (__webpack_exec__(96075)));
